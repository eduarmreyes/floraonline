...
<table class="table table-bordered">
	...
	<td><strong><h2> $75.00</h2></strong></td>
	</tr>
	<?php foreach ($_SESSION["carrito"] as $iKey => $aCarrito) {
		var_dump($iKey);
		var_dump($aCarrito);
	} ?>
	<tr>
...
<div class="container">
	...
	<label for="nombre">Nombre:</label>
  	<input class="form-control" id="Nombre" type="text" placeholder="Nombre" pattern="[A-Za-z]*" required>
	</div>
	<div class="form-group">
 	<label for="apellido">Apellido:</label>
	<input class="form-control" type="text" name="Apellidos" placeholder="Apellidos" pattern="[A-Za-z]*" required>
	</div>
	<div class="form-group">
	<label  for="Telefono">Telefono:</label>
	<input class="form-control" type="tel" name="telefono" placeholder="+503" pattern="[0-9]{8}" required>
	</div>
	<div class="form-group">
	<label for="email">Correo Electronico:</label>
	<input class="form-control" type="e-mail" name="correo"  placeholder="Correo electronico">
	</div>
	<div class="form-group">
	<label for="Seleccionar">Localidad:</label>
	<input list="uno" class="form-control"  name="selec" placeholder="Seleccionar"><br>
	<datalist id="uno">
	...
	<input class="form-control" type="tel" name="tarjeta" placeholder="6############" pattern="[0-9]{8}" required>
	</div>
</form>
</td>
</tr>
...
<a href="p2.html"><button class="btn btn-success">Comprar Ahora</button></a>
</div>
