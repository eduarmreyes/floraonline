...
if (isset($_GET["addme"])) {
	...
	$aArregloFloral = array(
			...
			"cantidad"	=>		1,
			"precio"		=>		12.95,
			"nombre"		=>		"Arreglo de Rosas Pequeño"
		);
				...
				<article>
					<div class="container">
						<?php if (isset($_GET["addme"])) { ?>
							<div class="alert alert-success" role="alert"><strong>Arreglo de Rosas Pequeño</strong> agregado correctamente al carrito de compras. Total a Pagar: <?php echo $_SESSION["oCarrito"]->precio_total(); ?> <a href="cancelar.php">Proceder a pagar</a></div>
						<?php } ?>

						<table class="table table-bordered">
							<tr class="active">
								<th><h1>Arreglo de Rosas Pequeño</h1></th>
							</tr>
							<tr>
								<td><img src="../imagenes/img15.jpg"></td>
